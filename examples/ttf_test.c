...
void draw(graphic_window_t* window, void* point) {
    ...
    change_text(window, texts, buffer_value, delete ? 2 : 1);
    ...
    move_text(texts, delete ? 3 : 2, x, y);
...
int main(void) {
    ...
    texts = texts_init("/System/Library/Fonts/Supplemental/Chalkduster.ttf", 24);
    ...
    change_visibility_text(texts, 0, true);
    change_visibility_text(texts, 1, true);
    change_visibility_text(texts, 2, true);
    change_visibility_text(texts, 3, true);
